...
CREATE TABLE BOOKMARK (
    ...
    HOSPITAL_ID			BIGINT,
    PHARMACY_ID			BIGINT,
    FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (MEMBER_IDX) ON DELETE CASCADE,
    FOREIGN KEY (HOSPITAL_ID) REFERENCES HOSPITAL (HOSPITAL_ID) ON DELETE CASCADE,
    FOREIGN KEY (PHARMACY_ID) REFERENCES PHARMACY (PHARMACY_ID) ON DELETE CASCADE,
    CONSTRAINT UNIQUE_MEMBER_HOSPTIAL UNIQUE (MEMBER_ID, HOSPITAL_ID),
    CONSTRAINT UNIQUE_MEMBER_PHARMACY UNIQUE (MEMBER_ID, PHARMACY_ID)
);
